...
# 拷贝 SPM resource bundle（ImageAssets.swift 的 loadTrayIcon 直接引用 Bundle.module）
cp -R "$BUILD_DIR/arm64-apple-macosx/release/LLMProxy_LLMProxy.bundle" "$APP/Contents/Resources/"

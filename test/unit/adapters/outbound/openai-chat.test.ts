  ...
  messages: [
    { role: 'user', blocks: [{ kind: 'text', text: 'hi' }] },
    {
      ...
      blocks: [
        ...
        { kind: 'tool_use', id: 'c1', name: 'run', namespace: 'mcp__x__', input: { x: 1 } },
      ],
    },
  ],
  generation: { stream: false, maxTokens: 123 },
  reasoning: { source: 'client', effort: 'high' },
  tools: [{ kind: 'function', name: 'run', namespace: 'mcp__x__', schema: { type: 'object' } }],
};

...
const req: CanonicalRequest = {
  ...
  messages: [
    { role: 'user', blocks: [{ kind: 'text', text: 'hi' }] },
    {
      role: 'assistant',
      blocks: [
        { kind: 'thinking', text: 'think', signature: 'sig' },
        { kind: 'tool_use', id: 'c1', name: 'run', namespace: 'mcp__x__', input: { a: 1 } },
      ],
    },
  ],
  system: [{ kind: 'text', text: 'system' }],
  generation: { stream: false },
  reasoning: { source: 'route', enabled: true, effort: 'high', budgetTokens: 4096 },
  tools: [
    { kind: 'function', name: 'run', namespace: 'mcp__x__', schema: { type: 'object' } },
    { kind: 'computer', name: 'computer', schema: {}, displayWidth: 100 },
  ],
};
